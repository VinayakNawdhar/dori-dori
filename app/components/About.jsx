...
const About = () => {
    return (
        <section id='about' className='py-10 bg-white/70 flex flex-col gap-5 md:scroll-m-[110px] scroll-m-[80px]'>
            ...
            <div className='flex px-8 lg:flex-row-reverse flex-wrap items-center mt-10 about-2'>
                <div className='md:w-1/2 flex flex-col gap-5 mb-10 md:mb-0'>
                    <h1 className='md:w-[60%] text-left text-2xl md:text-5xl font-extrabold tracking-tighter font-[Archivo]'>NOT JUST ANOTHER BAKER.</h1>
                    <div>
                    <p className='md:w-[75%] font-["Archivo"] tracking-tight opacity-75'>Gourmet marshmallows and cookies are crafted with passion and precision. we believe in elevating the simple pleasure of indulgence into an art form. Our journey began with a vision to redefine the boundaries of flavor and texture, creating treats that tantalize the taste buds and ignite the imagination.</p>
                    <p className='md:w-[75%] font-["Archivo"] tracking-tight opacity-75'>we're a community united by our love for exceptional treats and shared experiences. Whether you're savoring a moment of indulgence alone or sharing our delights with loved ones, we invite you to join us on a journey of flavor and discovery.</p>
                    </div>
                </div>
                <div className='md:w-1/2 flex justify-center'>
                    <div className='overflow-hidden rounded-2xl md:h-[500px] md:w-[500px] '>
