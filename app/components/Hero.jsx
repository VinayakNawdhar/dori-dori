  ...
  return (
    <section className="pt-[110px] relative" id="hero">
      ...
      <div className="img-div grid gap-10 justify-center xl:absolute top-0 xl:right-[300px]">
        <img src="/images/cookie-1.png" className="h-[130px] xl:h-[200px] rotate-[30deg]" alt="" />
        <div className="relative">
          <img src="/images/cookie-2.webp" className="h-[130px] xl:h-[200px] rotate-[-30deg]" alt="" />
        ...
        <img src="/images/cookie-3.png" className="h-[130px] xl:h-[200px] rotate-[30deg]" alt="" />
      </div>
    </section>
  )
}
