...
const Testimonial = () => {
    return (
        <section id='reviews' className="bg-white/90 py-16 md:scroll-m-[110px] scroll-m-[80px]">
            <h1 className='px-10 text-2xl md:text-5xl font-extrabold text-center font-["Outfit"] tracking-tighter drop-shadow-2xl'>WHAT OUR CUSTOMER SAYS</h1>
            <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6 flex gap-8 md:flex-wrap items-stretch overflow-x-scroll md:overflow-auto">
                {testimonials.map(test => (
                    <figure key={test.id} className="hover-target bg-[#FEFAF9] min-w-[250px] h-[300px] p-4 rounded-2xl shadow-2xl md:h-96 md:w-96 relative pb-20 md:pb-0">
                        <svg className="h-12 mx-auto mb-3 text-gray-400 dark:text-gray-600" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.017 18L14.017 10.609C14.017 4.905 17.748 1.039 23 0L23.995 2.151C21.563 3.068 20 5.789 20 8H24V18H14.017ZM0 18V10.609C0 4.905 3.748 1.038 9 0L9.996 2.151C7.563 3.068 6 5.789 6 8H9.983L9.983 18L0 18Z" fill="currentColor" />
                        </svg>
                        <blockquote>
                            <p className="text-sm md:text-xl font-medium text-gray-900 opacity-90">"{test.text}"</p>
                        </blockquote>
                        <figcaption className="flex items-center justify-center mt-6 space-x-3 absolute left-1/2 translate-x-[-50%] md:bottom-10">
