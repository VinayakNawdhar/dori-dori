...
const Testimonial = () => {
    return (
        <section id='reviews' class="bg-white/90 py-16 md:scroll-m-[110px] scroll-m-[80px]">
            ...
            <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6 flex gap-8 flex-wrap">
                {testimonials.map(test => (
                    <figure key={test.id} class="hover-target bg-[#FEFAF9] p-4 rounded-2xl shadow-2xl xl:h-96 xl:w-96 relative pb-20 xl:pb-0">
