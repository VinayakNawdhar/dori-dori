...
const Products = () => {
  return (
    <section id='product' className='min-h-screen pt-32 pb-8'>
        <h1 className='text-6xl text-center font-extrabold tracking-tighter text-black/85 mb-5'>Indulge Your Craving!</h1>
        <h3 className='text-center font-semibold text-xl tracking-tighter'>because classic treats never go out of style</h3>
        <div className='px-10 py-4 bg-white/50 mx-5 rounded-xl mt-8'>
            <h1 className='text-5xl mb-8 font-semibold font-["Outfit"]'>Gourmet Marshmallows</h1>
        ...
        <div className='px-10 py-4 bg-red-900/10 mx-5 rounded-xl mt-8'>
            <h1 className='text-5xl mb-8 font-semibold font-["Outfit"]'>New York Style Cookies </h1>
            <div className='flex flex-wrap gap-8 justify-center'>
                <div className='w-[350px] h-[350px] overflow-hidden relative product rounded-xl'>
                    <div className='w-[350px] h-[350px] overflow-hidden product-img '>
