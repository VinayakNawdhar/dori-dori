...
const Products = () => {
    ...
    return (
        <section id='product' className='min-h-screen mt-[50px] xl:mt-0 xl:pt-32 pb-8 scroll-m-[120px] md:scroll-m-0'>
            ...
            <div id='gm' className='px-2 py-3 xl:px-10 xl:py-4 bg-white/50 mx-5 rounded-xl mt-8'>
